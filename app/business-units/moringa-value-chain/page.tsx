...
export default function MoringaValueChainPage() {
  return (
    <>
            ...
            <AnimatedSection>
              <div className="w-full max-w-4xl mx-auto text-center text-white px-4 sm:px-6 md:px-8 lg:px-12">
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 max-w-3xl mx-auto drop-shadow-lg leading-relaxed mb-0 mt-3 sm:mt-4 px-2">
                  A fully integrated moringa value chain—from cultivation and harvesting to drying, milling, and packaging.
                </p>
          ...
          <AnimatedSection>
            <div>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                We operate a fully integrated moringa value chain—from cultivation and harvesting to drying, milling, and packaging.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Our moringa products meet quality standards for nutritional and herbal markets.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.2}>
            <Card className="bg-gradient-to-br from-[#0F6131] to-[#8EBA3E] text-white border-0 shadow-xl">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">Training & Development</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-white/90 leading-relaxed">
                  We also train farmers and youth in best-practice moringa production.
                </p>
              </CardContent>
            </Card>
          </AnimatedSection>
